...
This is a community-maintained client for the third-party kino.pub service. It contains **no bundled
credentials or API keys** — the app authenticates with your own kino.pub account via the device-code
flow. Reports about the kino.pub backend itself should go to kino.pub, not here.
